...
{
    public class SevisValidationResult
    {
        internal SevisValidationResult()
        {

        }

        /// <summary>
        /// Creates a new SevisValidationResult with the given error message.
        /// </summary>
        ...
        public SevisValidationResult(string property, string errorMessage)
        {
    ...
    /// <summary>
    /// The SevisValidationResult contains an error message and a property name of the business entity
    /// that failed validation.
    /// </summary>
    /// <typeparam name="T">The business entity.</typeparam>
    public class SevisValidationResult<T> : SevisValidationResult where T : class
    {
        /// <summary>
        /// Creates a new SevisValidationResult with the expression to the property that failed validation and the
        /// error message.
        /// </summary>
        ...
        public SevisValidationResult(Expression<Func<T, object>> propertySelector, string errorMessage)
        {
