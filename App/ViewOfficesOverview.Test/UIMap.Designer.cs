...
namespace ViewOfficesOverview.Test
{
    ...
    public partial class UIMap
    {
        ...
        /// <summary>
        /// Verify the navigation takes you to the correct page and displays (ECA Office Directory) in the banner heading. Check innertext.
        /// </summary>
        public void AssertAllOfficesBanner()
        {
            #region Variable Declarations
            HtmlDiv uIECAOfficeDirectoryPane = this.UIHttpsecakmtqaazureweWindow1.UIHttpsecakmtqaazureweDocument.UITopPane.UIECAOfficeDirectoryPane;
            #endregion

            // Wait for 10 seconds for user delay between actions; Verify that the 'InnerText' property of 'ECA Office Directory' pane contains 'ECA Office Directory'
            //Playback.Wait(10000);
            PlaybackSettings.Equals(mAssertAllOfficesBannerExpectedValues, AssertAllOfficesBannerExpectedValues);
            Playback.Wait(10000);
            StringAssert.Contains(uIECAOfficeDirectoryPane.InnerText, this.AssertAllOfficesBannerExpectedValues.UIECAOfficeDirectoryPaneInnerText, "No ECA Office Directory display in heading available.");
        }
