...
{
    /// <summary>
    /// An IPositionService is capable of performing crud operations on SEVIS USGovernmentAgencies.
    /// </summary>
    public interface IUSGovernmentAgencyService
    {
        /// <summary>
        /// Returns paged, filtered and sorted USGovernmentAgencies in the system.
        /// </summary>
