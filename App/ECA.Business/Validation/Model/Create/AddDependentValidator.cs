...
namespace ECA.Business.Validation.Model
{
    public class AddDependentValidator : AbstractValidator<AddDependent>
    {
        ...
        public AddDependentValidator()
        {
            ...
            RuleFor(student => student.BirthCountryCode).NotNull().Length(2).WithMessage("Dependent: Country of birth is required");
            ...
            RuleFor(student => student.VisaType).NotNull().Length(2).WithMessage("Dependent: Visa type is required");
            RuleFor(student => student.Relationship).NotNull().Length(2).WithMessage("Dependent: Visa type is required");
