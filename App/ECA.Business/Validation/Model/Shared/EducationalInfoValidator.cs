...
namespace ECA.Business.Validation.Model.Shared
{
    public class EducationalInfoValidator : AbstractValidator<EducationalInfo>
    {
        ...
        public EducationalInfoValidator()
        {
            ...
            RuleFor(student => student.PrimaryMajor).NotNull().Length(1, MAJOR_MAX_LENGTH).WithMessage("Education: Primary Major is required and can be up to " + MAJOR_MAX_LENGTH.ToString() + " characters");
            ...
            RuleFor(student => student.LengthOfStudy).NotNull().Length(1, STUDY_MAX_LENGTH).WithMessage("Education: Length of Study can be up to " + STUDY_MAX_LENGTH.ToString() + " characters");
            ...
            RuleFor(student => student.engProficiency).NotNull().SetValidator(new EngProficiencyValidator());
