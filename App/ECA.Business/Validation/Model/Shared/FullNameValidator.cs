...
namespace ECA.Business.Validation.Model.Shared
{
    public class FullNameValidator : AbstractValidator<FullName>
    {
        ...
        {
            RuleFor(student => student.FirsName).NotNull().Length(1, FIRST_NAME_MAX_LENGTH).WithMessage("Full Name: First Name is required and can be up to " + FIRST_NAME_MAX_LENGTH.ToString() + " characters");
