...
namespace ECA.Business.Validation.Model.Shared
{
    public class StudentValidator : AbstractValidator<Student>
    {
        ...
        public StudentValidator()
        {
            ...
            RuleFor(student => student.IssueReason).NotNull().Length(1, ISSUE_REASON_STRING_LENGTH).WithMessage("Student: Issue Reason is required and can be up to " + ISSUE_REASON_STRING_LENGTH.ToString() + " characters");
