...
namespace ECA.Business.Validation.Model.Shared
{
    public class EditTippSiteValidator : AbstractValidator<EditTippSite>
    {
        ...
        public EditTippSiteValidator()
        {
            ...
            RuleFor(tipp => tipp.Address1).Length(1, ADDRESS_MAX_LENGTH).WithMessage("T/IPP Site: Address Line 1 is required and can be up to " + ADDRESS_MAX_LENGTH.ToString() + " characters");
            ...
            RuleFor(tipp => tipp.PostalCode).Length(POSTAL_CODE_LENGTH).WithMessage("T/IPP Site: Postal Code is required and must be " + POSTAL_CODE_LENGTH.ToString() + " digits").Matches(@" ^\d{5}$").WithMessage("T/IPP Site: Postal Code must be numeric");
            ...
            RuleFor(tipp => tipp.SiteName).Length(1, SITE_MAX_LENGTH).WithMessage("T/IPP Site: Site Name is required and can be up to " + SITE_MAX_LENGTH.ToString() + " characters");
            ...
            RuleFor(tipp => tipp.EmployerID).Length(1, 9).WithMessage("T/IPP Site: Site Name is required and can be up to 9 characters");
            RuleFor(tipp => tipp.FullTimeEmployees).Length(1, 6).WithMessage("T/IPP Site: Number of full time employees is required and must be between 1 and 6 characters");
            RuleFor(tipp => tipp.AnnualRevenue).Length(1, 2).WithMessage("T/IPP Site: Annual Revenue amount is required and can be up to 2 characters");
            RuleFor(tipp => tipp.WebsiteURL).Length(1, 250).WithMessage("T/IPP Site: Website URL is required and can be up to 250 characters");
            ...
            RuleFor(tipp => tipp.EvHoursPerWeek).Length(1, 2).WithMessage("T/IPP Site: Exchange visitor hours per week is required and can be up to 2 characters");
            ...
            RuleFor(tipp => tipp.SupervisorLastName).Length(1, 40).WithMessage("T/IPP Site: Supervisor last name is required and can be up to 40 characters");
            RuleFor(tipp => tipp.SupervisorFirstName).Length(1, 40).WithMessage("T/IPP Site: Supervisor first name is required and can be up to 40 characters");
            RuleFor(tipp => tipp.SupervisorTitle).Length(1, 100).WithMessage("T/IPP Site: Supervisor title is required and can be up to 100 characters");
            RuleFor(tipp => tipp.SupervisorPhone).Length(1, 10).WithMessage("T/IPP Site: Supervisor telephone number is required and can be up to 10 characters");
            RuleFor(tipp => tipp.SupervisorPhoneExt).Length(0, 4).WithMessage("T/IPP Site: Supervisor telephone number extenstion can be up to 4 characters");
            RuleFor(tipp => tipp.SupervisorEmail).Length(1, 255).WithMessage("T/IPP Site: Supervisor Email address is required and can be up to 255 characters");
            RuleFor(tipp => tipp.SupervisorFax).Length(0, 10).WithMessage("T/IPP Site: Supervisor fax number can be up to 10 characters");
            RuleFor(tipp => tipp.OfficialUserName).Length(7, 10).WithMessage("T/IPP Site: Global username type is required and must be between 7 and 10 characters");
        }
    }
}