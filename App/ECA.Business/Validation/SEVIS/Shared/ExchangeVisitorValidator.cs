...
namespace ECA.Business.Validation.Model.CreateEV
{
    public class ExchangeVisitorValidator : AbstractValidator<ExchangeVisitor>
    {
        ...
        public ExchangeVisitorValidator()
        {
            ...
            RuleFor(visitor => visitor.CategoryCode).NotNull().WithMessage("Exch. Visitor: Program category is required").Length(1, CATEGORY_CODE_LENGTH).WithMessage("Exch. Visitor: Program category is required and can be up to " + CATEGORY_CODE_LENGTH.ToString() + " characters");
            ...
            RuleFor(visitor => visitor.CreateDependent).SetCollectionValidator(new CreateDependentValidator()).When(visitor => visitor.CreateDependent != null);
