...
namespace ECA.Business.Validation.Model.CreateEV
{
    public class BiographicalValidator : AbstractValidator<Biographical>
    {
        ...
        public const string PERMANENT_RESIDENCE_COUNTRY_CODE_ERROR_MESSAGE = "EV Biographical Info: Permanent Residence Country is required.  Add an address to this person.";
        ...
        public BiographicalValidator()
        {
            ...
            RuleFor(visitor => visitor.EmailAddress)
                ...
                .WithState(x => new ContactErrorPath())
                .EmailAddress()
