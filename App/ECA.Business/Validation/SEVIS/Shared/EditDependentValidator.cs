...
namespace ECA.Business.Validation.Model
{
    public class EditDependentValidator : AbstractValidator<EditDependent>
    {
        ...
        public EditDependentValidator()
        {
            ...
            RuleFor(student => student.Gender).NotNull().WithMessage("Edit Dependent: Gender is required").Matches("(M|F)").WithMessage("EV Biographical Info: Gender must be M or F");
            ...
            RuleFor(student => student.EmailAddress).Length(0, EMAIL_MAX_LENGTH).WithMessage("Edit Dependent: Email can be up to " + EMAIL_MAX_LENGTH.ToString() + " characters").EmailAddress().WithMessage("Dependent: Email is invalid");
