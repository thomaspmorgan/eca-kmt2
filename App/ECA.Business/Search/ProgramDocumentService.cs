...
namespace ECA.Business.Search
{
    ...
    {
        public ProgramDocumentService(EcaContext context, IIndexService indexService, IIndexNotificationService notificationService, int batchSize = 50) : base(context, indexService, notificationService, batchSize)
        {
