...
angular.module('staticApp')
  .controller('AddFundingModalCtrl', function ($q, $scope, $modalInstance, $log, FilterService, OrganizationService, ConstantsService, LookupService, NotificationService) {
      ...
      function saveOrganization() {
          ...
          $scope.view.organization.organizationRoles.push(ConstantsService.organizationRole.fundingSource.id);
          ...
          .catch(function (response) {
              $scope.view.isSavingOrganization = false;
              var message = 'Unable to save funding source.';
      ...
      $scope.view.onOrganizationNameChange = function () {
          ...
          if (organizationName && organizationName.length > 0) {
              ...
              return OrganizationService.getOrganizations(organizationsWithSameNameFilter.toParams())
                  ...
                  .catch(function (response) {
                      $scope.view.isLoadingLikeOrganizations = false;
                      var message = "Unable to load matching funding sources.";
                      $log.error(message);
                      NotificationService.showErrorMessage(message);
                  });
          }
