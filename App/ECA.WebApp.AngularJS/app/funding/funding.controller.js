...
/**
 * @ngdoc function
 * @name staticApp.controller:FundingCtrl
 * @description The overview controller is used on the for general purpose funding management.
 * # FundingCtrl
 * Controller of the staticApp
 */
angular.module('staticApp')
  .controller('FundingCtrl', function (
        $scope,
        $stateParams,
        $q,
        $log,
      ...
      $scope.tabs = {
          ...
          activity: { title: 'Timeline', path: 'activities', active: true, order: 3 },
          fundings: { title: 'Funding', path: 'moneyflows', active: true, order: 4 }
      };
