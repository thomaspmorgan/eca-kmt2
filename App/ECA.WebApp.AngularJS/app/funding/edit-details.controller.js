...
/**
 * @ngdoc function
 * @name staticApp.controller:FundingEditCtrl
 * @description The edit controller is used on the edit view of a funding source.
 * # FundingOverviewCtrl
 * Controller of the staticApp
 */
angular.module('staticApp')
  .controller('FundingEditDetailsCtrl', function (
        $scope,
        $stateParams,
        $q,
        $log,
