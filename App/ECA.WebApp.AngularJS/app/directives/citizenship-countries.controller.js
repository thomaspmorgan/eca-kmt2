...
angular.module('staticApp')
  .controller('CitizenshipCountriesCtrl', function (
      ...
      $scope.view.onAddCitizenshipCountryClick = function (countriesOfCitizenship) {
          ...
          $scope.$parent.$parent.$parent.model.countriesOfCitizenship.splice(0, 0, newCountry);
      ...
      $scope.$on(ConstantsService.removeNewCitizenshipCountryEventName, function (event, newCountry) {
          console.assert($scope.$parent.$parent.$parent.model.countriesOfCitizenship instanceof Array, 'The entity countries is defined but must be an array.');

          var countries = $scope.$parent.$parent.$parent.model.countriesOfCitizenship;
