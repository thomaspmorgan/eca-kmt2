 ...
 * @description
 * # Get parameters for YearAwards and execute report
 * Controller of the staticApp
 */
angular.module('staticApp')
  .controller('YearAwardsCtrl', function ($scope, $modalInstance, $log, ProgramService, LocationService, parameters, ReportService, DownloadService) {
      ...
      $scope.run = function () {
          ...
          .then(function () {
              ...
              $log.error('Unable to download year awards report.');
          })
          .then(function () {
              $scope.isRunning = false;
