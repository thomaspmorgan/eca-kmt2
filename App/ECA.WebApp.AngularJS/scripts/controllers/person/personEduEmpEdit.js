  ...
  .controller('personEducationEmploymentEditCtrl', function (
      ...
      $scope.view.saveEmploymentChanges = function () {
          ...
          if (isNewEmployment($scope.employment)) {
              ...
              EduEmpService.addProfessionEducation($scope.employment, $scope.view.personId)
              ...
              EduEmpService.updateProfessionEducation($scope.employment, $scope.view.personId)
                  .then(onSaveEmploymentSuccess)
                  .catch(onSaveEmploymentError);
          }
      };
      ...
      $scope.$on(ConstantsService.removeNewEmploymentEventName, function (event, newEmployment) {
          ...
          console.assert($scope.model.employment instanceof Array, 'The entity employment is defined but must be an array.');

          var employments = $scope.model.employment;
