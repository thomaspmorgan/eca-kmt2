...
namespace ECA.Business.Test.Service.Persons
{
    ...
    public class ExchangeVisitorValidationServiceTest
    {
        ...
        [TestMethod]
        public async Task TestRunParticipantSevisValidation_ParticipantDoesNotHaveAnyStatuses_ValidationFails()
        {
            var project = new Project
            {
                ProjectId = 1,
        ...
        [TestMethod]
        public async Task TestRunParticipantSevisValidation_ParticipantDoesNotNeedValidationInfo_ValidationSucceeds()
        {
            var project = new Project
            {
                ProjectId = 1,
        ...
        [TestMethod]
        public async Task TestRunParticipantSevisValidation_ParticipantDoesNotNeedValidationInfo_ValidationFails()
        {
            var project = new Project
            {
                ProjectId = 1,
        ...
        [TestMethod]
        public async Task TestRunParticipantSevisValidation_ParticipantHasNeededValidationInfo_ValidationSucceeds()
        {
            var project = new Project
            {
                ProjectId = 1,
        ...
        [TestMethod]
        public async Task TestRunParticipantSevisValidation_ParticipantHasNeededValidationInfo_ValidationFails()
        {
            var project = new Project
            {
                ProjectId = 1,
