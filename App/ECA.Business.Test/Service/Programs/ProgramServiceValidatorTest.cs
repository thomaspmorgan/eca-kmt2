...
namespace ECA.Business.Test.Service.Programs
{
    ...
    public class ProgramServiceValidatorTest
    {
        ...
        public void TestValidate_WhitespaceDescription()
        {
            ...
            var entity = new ProgramServiceValidationEntity(name, description, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, parentProgramId, parentProgram);
            var results = validator.Validate(entity).ToList();
            Assert.AreEqual(0, results.Count);

            entity = new ProgramServiceValidationEntity(name, " ", locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, parentProgramId, parentProgram);
        ...
        public void TestValidate_EmptyDescription()
        {
            ...
            entity = new ProgramServiceValidationEntity(name, String.Empty, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds,  owner, parentProgramId, parentProgram);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(ProgramServiceValidator.INVALID_DESCRIPTION_ERROR_MESSAGE, validationResult.ErrorMessage);
        ...
        public void TestValidate_NullDescription()
        {
            ...
            entity = new ProgramServiceValidationEntity(name, null, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, parentProgramId, parentProgram);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(ProgramServiceValidator.INVALID_DESCRIPTION_ERROR_MESSAGE, validationResult.ErrorMessage);
        ...
        public void TestValidate_WhitespaceName()
        {
            ...
            entity = new ProgramServiceValidationEntity(" ", description, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, parentProgramId, parentProgram);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
        ...
        public void TestValidate_EmptyName()
        {
            ...
            entity = new ProgramServiceValidationEntity(String.Empty, description, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, parentProgramId, parentProgram);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(ProgramServiceValidator.INVALID_NAME_ERROR_MESSAGE, validationResult.ErrorMessage);
        ...
        public void TestValidate_NullName()
        {
            ...
            entity = new ProgramServiceValidationEntity(null, description, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, parentProgramId, parentProgram);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(ProgramServiceValidator.INVALID_NAME_ERROR_MESSAGE, validationResult.ErrorMessage);
        ...
        public void TestValidate_ParentProgramIdHasValue_ParentProgramIsNull()
        {
            ...
            entity = new ProgramServiceValidationEntity(name, description, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds,  owner, parentProgramId, null);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
        ...
        public void TestValidate_ParentProgramIdDoesNotHaveValue()
        {
            ...
            entity = new ProgramServiceValidationEntity(name, description, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, null, parentProgram);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(0, results.Count);
        ...
        public void TestValidate_NullContactIds()
        {
            ...
            contactIds = null;
            entity = new ProgramServiceValidationEntity(name, description, locationTypeIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds,  owner, parentProgramId, parentProgram);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
