...
namespace ECA.Business.Test.Service.Programs
{
    ...
    public class ProgramServiceValidatorTest
    {
        ...
        public void TestValidate_WhitespaceDescription()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, name, " ", locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, parentProgram, parentPrograms);
        ...
        public void TestValidate_EmptyDescription()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, name, String.Empty, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(PropertyHelper.GetPropertyName<EcaProgram>(x => x.Description), validationResult.Property);
        ...
        public void TestValidate_NullDescription()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, name, null, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(PropertyHelper.GetPropertyName<EcaProgram>(x => x.Description), validationResult.Property);
        ...
        public void TestValidate_WhitespaceName()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, " ", description, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
        ...
        public void TestValidate_EmptyName()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, String.Empty, description, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(PropertyHelper.GetPropertyName<EcaProgram>(x => x.Name), validationResult.Property);
        ...
        public void TestValidate_NullName()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, null, description, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(PropertyHelper.GetPropertyName<EcaProgram>(x => x.Name), validationResult.Property);
        ...
        public void TestValidate_OwnerOrganizationIsNull()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, name, description, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, null, officeSettings, parentProgramId, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
        ...
        public void TestValidate_OwnerRequiresCategories_EmptyCategoryIds()
        {
            ...
            categoryIds.Clear();
            entity = new ProgramServiceValidationEntity(programId, name, description, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(PropertyHelper.GetPropertyName<EcaProgram>(x => x.FocusCategoryIds), validationResult.Property);
        ...
        public void TestValidate_OwnerRequiresObjectives_EmptyObjectiveIds()
        {
            ...
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
            Assert.AreEqual(PropertyHelper.GetPropertyName<EcaProgram>(x => x.JustificationObjectiveIds), validationResult.Property);
        ...
        public void TestValidate_ParentProgramIdHasValue_ParentProgramIsNull()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, name, description, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, parentProgramId, null, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(1, results.Count);
            var validationResult = results.First();
        ...
        public void TestValidate_ParentProgramIdDoesNotHaveValue()
        {
            ...
            entity = new ProgramServiceValidationEntity(programId, name, description, locationTypeIds, inactiveRegionIds, contactIds, themeIds, goalIds, regionIds, categoryIds, objectiveIds, owner, officeSettings, null, parentProgram, parentPrograms);
            results = validator.Validate(entity).ToList();
            Assert.AreEqual(0, results.Count);
