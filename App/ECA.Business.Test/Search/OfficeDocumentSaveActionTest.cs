...
{
    [TestClass]
    public class OfficeDocumentSaveActionTest
    {
        private NameValueCollection appSettings;
        private ConnectionStringSettingsCollection connectionStrings;
        private AppSettings settings;
        private OfficeDocumentSaveAction saveAction;
        ...
        public void TestInit()
        {
            ...
            saveAction = new OfficeDocumentSaveAction(settings);
        }

        [TestMethod]
        public void TestGetDocumentKey()
        {
            var documentTypeId = OfficeDTODocumentConfiguration.OFFICE_DTO_DOCUMENT_TYPE_ID;
        ...
        public void TestIsOffice()
        {
            ...
            {
                var isExpectedToBeOffice = false;
                if (officeTypeIds.Contains(orgType.Id))
                {
                    isExpectedToBeOffice = true;
                }
                var testOrganization = new Organization
                {
                    OrganizationTypeId = orgType.Id
                };
                Assert.AreEqual(isExpectedToBeOffice, saveAction.IsOffice(testOrganization));
            }
        }
