...
PRINT 'Updating static data table [dbo].[MaritalStatus]'
...
INSERT INTO @tblTempTable ([MaritalStatusId], [Status], [Description], [History_CreatedBy], [History_CreatedOn], [History_RevisedBy], [History_RevisedOn]) VALUES ('1', 'M', 'Married', '0', '3/27/2015 12:00:00 AM -05:00', '0', '3/27/2015 12:00:00 AM -05:00')
...
BEGIN
	DELETE FROM [dbo].[MaritalStatus] FROM [dbo].[MaritalStatus] LiveTable
	LEFT JOIN @tblTempTable tmp ON LiveTable.[MaritalStatusId] = tmp.[MaritalStatusId]
	WHERE tmp.[MaritalStatusId] IS NULL
END

PRINT 'Finished updating static data table [dbo].[MaritalStatus]'
