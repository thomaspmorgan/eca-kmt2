...
SELECT @OfficeId = organizationid FROM organization WHERE officesymbol = 'ECA/EC'
...
VALUES 
--Program
('Summer Work Travel',NULL,@OfficeId)
,('Intern',NULL,@OfficeId)
,('Trainee',NULL,@OfficeId)
,('Specialist',NULL,@OfficeId)
,('Camp Counselor',NULL,@OfficeId)
,('Au Pair',NULL,@OfficeId)
,('Short Term Scholar',NULL,@OfficeId)
,('Research Scholar',NULL,@OfficeId)
,('College and University Student',NULL,@OfficeId)
,('High School Student',NULL,@OfficeId)
,('Physician',NULL,@OfficeId)
,('Professor',NULL,@OfficeId)
 


--Program/Subprogram
,('General','Summer Work Travel',@OfficeId)
,('Australia/New Zealand Pilot','Summer Work Travel',@OfficeId)
,('General','Intern',@OfficeId)
,('Intern Work Travel (Ireland)','Intern',@OfficeId)
,('Intern Work Travel (Korea West)','Intern',@OfficeId)
,('Intern Work Travel (Mexico)','Intern',@OfficeId)
,('EduCare','Au Pair',@OfficeId)
,('General','Au Pair',@OfficeId)
