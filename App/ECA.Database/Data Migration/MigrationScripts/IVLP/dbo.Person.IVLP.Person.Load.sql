...
SELECT p.FIRST_NAME,p.LAST_NAME,p.PREFIX_CD,p.SUFFIX_CD,p.MIDDLE_NAME,g.genderid,p.BIRTH_DATE,
	0, CAST(N'2015-04-04T00:00:00.0000000-00:00' AS DateTimeOffset), 0, CAST(N'2015-04-04T00:00:00.0000000-00:00' AS DateTimeOffset),
...
LEFT JOIN eca_dev.eca_dev.dbo.gender g 
  ON (g.gendername = 	CASE 
			...
			ELSE 'Other'
			END)
LEFT JOIN eca_dev.eca_dev.dbo.maritalstatus m ON (m.status = CASE WHEN p.MARITAL_STATUS IS NULL THEN 'N' ELSE p.MARITAL_STATUS END)
